...
class FaceMatch:
    ...
    def comapre(self, img1, img2):
        print(self.vgg_face_descriptor.predict(self.preprocess_image(img1)).shape)
        ...
        # ban đầu < 0.3 nhưng data false quá nhiều
...
if __name__ == '__main__':
    ...
    print(api.comapre('./DataCroped/DoanHuuVinh_VPDTN/01-DHV-VPDTN_0.jpg', './DataCroped/DoanHuuVinh_VPDTN/01-DHV-VPDTN_0.jpg'))
    # print(api.comapre('./Data/AC_Angela_Phuong_Trinh/Angela_Phuong_Trinh_0ID.jpg', './Data/AC_Angela_Phuong_Trinh/Angela_Phuong_Trinh_20.jpg'))