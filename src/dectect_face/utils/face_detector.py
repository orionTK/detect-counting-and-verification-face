...
# from dectect_face import models
...
# class MTCNN():
#     def __init__(self, model_path='~/align_mtcnn/mtcnn-model'):
#
#         mtcnn = MtcnnDetector(model_folder=model_path, ctx=ctx, num_worker=1, accurate_landmark=True)
#         detect = mtcnn
#
#
#     def detect_face(self, image):
