...
def get_data_DataIDFull(path):
    ...
    for root, dirs, files in tqdm(os.walk(path)):
        if files != []:
            for file in files:
                name_img = file.split('.')[0]
                # print('key', os.path.join('src', 'Image', 'label', '%s.txt' % (name_img)))
                print(os.path.exists(os.path.join('C:/Users/SV_Guest/Desktop/Kieu/DoAn/src/Image', 'label', '%s.txt' % (name_img))))
                if not os.path.exists(os.path.join('C:/Users/SV_Guest/Desktop/Kieu/DoAn/src/Image', 'label', '%s.txt' % (name_img))):
                    continue
                else:
                    # print("=============================================================================================")
                    #
                    ...
                    with open(os.path.join('C:/Users/SV_Guest/Desktop/Kieu/DoAn/src/Image', 'label', '%s.txt' % (name_img)), 'r') as f:
                        lines = f.readlines()
...
if __name__ == '__main__':
    ...
    # 'mobilenet_ssd', 'opencv',
    method = ['mobilenet_ssd', 'opencv','mtcnn']
    with open("detect_dataIDFull_final.csv", "w", newline="") as f:
    ...
    with open("detect_dataIDFull_final.csv", "r") as f:
