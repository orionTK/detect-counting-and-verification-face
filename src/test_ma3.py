...
def is_match(known_embedding, candidate_embedding, thresh=0.35):
    ...
    EuclideanDistance = findManhattanDistance(known_embedding, candidate_embedding)
...
def acc(i):
    ...
    data = load('lfw_embding_from_facenet.npz')
    data1 = load('lfw_embding_from_resnet50.npz')
    data2 = load('lfw_embding_from_setnet.npz')
    data3 = load('lfw_embding_from_vgg16.npz')
    # if (i == 0):
